...
{
    [TypeProperty("The name of the secret in Helm.", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
...
{
    [TypeProperty("The value of the secret in Helm.", ObjectTypePropertyFlags.Required | ObjectTypePropertyFlags.WriteOnly)]
    public required string Value { get; set; }
}

public class CertificateIdentifiers
{
    [TypeProperty("The name of the certificate in Helm.", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
    public required string Name { get; set; }
}
