...
using Azure.Security.Helm.Certificates;
...
public class CertificateHandler : TypedResourceHandler<Certificate, CertificateIdentifiers, Configuration>
{
    ...
    {
        static Azure.Security.Helm.Certificates.SubjectAlternativeNames GetSans(SubjectAlternativeNames input)
        {
            Azure.Security.Helm.Certificates.SubjectAlternativeNames output = new();
